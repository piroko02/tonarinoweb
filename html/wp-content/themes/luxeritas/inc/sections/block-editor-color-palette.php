...
<tbody>
<tr>
<th style="padding:0 10px"><?php echo __( 'Color', 'luxeritas' ) ?></td>
<th style="padding:0 10px"><?php echo __( 'Name', 'luxeritas' ) ?></td>
</tr>
<?php
$i = 0;
...
<td style="vertical-align:top"><input style="max-width:120px" type="text" id="<?php echo $name_key ?>" name="<?php echo $name_key ?>" value="<?php echo $name_value ?>" /></td>
</tr>
<?php
	++$i;
}
